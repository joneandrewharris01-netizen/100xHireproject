...
What I Did
Installed Cursor — Set up the Cursor IDE as my development environment.
Added extensions — Installed Codex and Claude Code, then connected both extensions to Cursor.
...
About This README
This README was written using a local voice-to-text model to help me articulate my thoughts more clearly.
